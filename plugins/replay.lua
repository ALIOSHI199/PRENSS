...
r(rr, "شبيك-ج عمو 🤔", o, f) 
elseif w== "مح"  then
r(rr, "محات حياتي🙈❤️", o, f) 
elseif w== "شكرا" or w== "ثكرا" then
r(rr, "{ •• الـّ~ـعـفو •• }", o, f) 
elseif w== "انته وين"  then
r(rr, "بالــبــ🏠ــيــت", o, f) 
elseif w== "🌚"  then
r(rr, "منور صخام الجدر😹☝️", o, f) 
elseif w== "😍"  then
r(rr, " يَمـه̷̐ إآلُحــ❤️ــب يَمـه̷̐ ❤️😍", o, f) 
elseif w== "اكرهك"  then
r(rr, "اني الأكثر 🌚", o, f) 
elseif w== "اريد اكبل"  then
r(rr, "خخ اني هم اريد اكبل قابل ربي وحد😹🙌", o, f) 
...
elseif w== "شكو ماكو"  then-- by @iq_100k
r(rr, "غيرك براسي ماكو 💨😽🚬", o, f) 
...
elseif w== "بوت"  then
r(rr, " اسمي كاسبر🌚🌸", o, f) 
elseif w== "مساعده"  then
r(rr, "لعرض قائمة المساعده اكتب الاوامر 🌚❤️", o, f) 
elseif w== "زاحف"  then
...
r(rr, "دييييات 🌝", o, f) 
elseif w== "اشكرك"  then
r(rr, "بخدمتك/ج حبي ❤️", o, f) 
elseif w== ""  then
r(rr, "", o, f) 
---------------------------------------------
elseif w == "انجب" or w == "نجب" and redis:get(rd) then
if is_sudo(msg) then 
