...
VOLUNTARYCHECK=0
I=1
BOT=bot_keko   # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
cat << EOF
 ...
 $f1 ▀▄keko_bot▄▀ $f2 keko_bot $f3 ▀▄keko_bot▄▀ $f4 keko_bot $f5 ▀▄keko_bot▄▀ $f6 keko_bot $rst
 $f1 ▀▄keko_bot▄▀ $f2 keko_bot $f3 ▀▄keko_bot▄▀ $f4 keko_bot $f5 ▀▄keko_bot▄▀ $f6 keko_bot $rst
 $f1 ▀▄keko_bot▄▀ $f2 keko_bot $f3 ▀▄keko_bot▄▀ $f4 keko_bot $f5 ▀▄keko_bot▄▀ $f6 keko_bot $rst
 $f1 ▀▄keko_bot▄▀ $f2 keko_bot $f3 ▀▄keko_bot▄▀ $f4 keko_bot $f5 ▀▄keko_bot▄▀ $f6 keko_bot $rst
...
echo -e "\033[38;5;208m      _       __                                \033[0;00m"
echo -e "\033[38;5;208m     |;|     / ;/                               \033[0;00m"
echo -e "\033[38;5;208m     |;|    / ;/                                \033[0;00m"
echo -e "\033[38;5;208m     |;|   / ;/                                 \033[0;00m"
echo -e "\033[38;5;208m     |;|  / ;/    ______                        \033[0;00m"
echo -e "\033[38;5;208m     |;| / ;/    | eko |                        \033[0;00m"
echo -e "\033[38;5;208m     |;| \ ;\                                   \033[0;00m"
echo -e "\033[38;5;208m     |;|  \ ;\                                  \033[0;00m"
echo -e "\033[38;5;208m     |;|   \ ;\                                 \033[0;00m"
echo -e "\033[38;5;208m     |;|    \ ;\                                \033[0;00m"
echo -e "\033[38;5;208m     |;|     \ ;\                               \033[0;00m"
echo -e "\033[38;5;208m               \e[01;34m       https://github.com/kekobot/bot_keko             \e[00;37;40m"
echo ""
cat << EOF
 $f1 ▀▄keko_bot▄▀ $f2 keko_bot $f3 ▀▄keko_bot▄▀ $f4 keko_bot $f5 ▀▄keko_bot▄▀ $f6 keko_bot $rst
 $f1 ▀▄keko_bot▄▀ $f2 keko_bot $f3 ▀▄keko_bot▄▀ $f4 keko_bot $f5 ▀▄keko_bot▄▀ $f6 keko_bot $rst
...
echo ""
echo -e "\033[38;5;208m  keko_bot : \033[0;00m"
echo -e "\033[38;5;208m @keko11keko \033[0;00m"
echo -e "\033[38;5;208m @kekkkoo    :)      @kekkkoo \033[0;00m"
echo -e "\033[38;5;208m @kekkkoo    :)      @kekkkoo \033[0;00m"
...
EOF
echo -e "                \e[100m                keko_bot               \e[00;37;40m"
echo -e "\033[38;5;208m      _       __                                \033[0;00m"
echo -e "\033[38;5;208m     |;|     / ;/                               \033[0;00m"
echo -e "\033[38;5;208m     |;|    / ;/                                \033[0;00m"
echo -e "\033[38;5;208m     |;|   / ;/                                 \033[0;00m"
...
if [ $CLINUM -eq 1 ]; then
  ...
  echo -e "$f2 RUNNING ZERO PROCESS OF keko_bot$rst"
fi
sleep 0.7
...
sleep 0.7
echo -e "$bld$f4 RELOADING keko_bot INFO...$rst"
sleep 0.7
...
if [ -z "${CLIPID}" ]; then
  echo -e "$f1 ERROR: keko_bot PROCESS NOT RUNNING$rst"
  sleep 3
  exit 1
fi
